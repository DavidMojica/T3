...
const form_split_id = document.getElementById('form-split-id');
const btn_ocultar_info = document.getElementById('btn_ocultar_info');
const btn_mostrar_info = document.getElementById('btn_mostrar_info');
...
btn_mostrar_info.addEventListener('click', function(){
    form_split_id.style.display = "none";
    hidden_div.style.display = "grid";
});

btn_ocultar_info.addEventListener('click', function(){
